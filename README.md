...
<ul>
  <li> Into ML, Agentic AI and stuff that uses graphs in useful ways, aka your knowledge graphs.</li>
  <li> Currently addicted to RAG and MCP for building personalized and autonomous AI agents.</li>
